          ...
          <div className="relative z-10 flex-1 lg:flex lg:items-center lg:-mx-6">
            <div className=" lg:w-1/2 lg:mx-6 pl-10">
              <div className="mt-6 space-y-8 md:mt-8">
                <div>
                  <h6 className="text-3xl pl-1 text-white">Address</h6>
                ...
                <div>
                  <h6 className="text-3xl pl-1 text-white">Phone Numbers</h6>
                  <div className="flex items-start -mx-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div>
                  <h6 className="text-3xl pl-1 text-white">Email Address</h6>
                  <div className="flex items-start -mx-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-7 h-7 mx-2 "
                ...
                <div>
                  <h6 className="text-3xl pl-1 text-white">Find our stores</h6>
                    <div className="flex items-start -mx-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-9 h-9 mx-2"

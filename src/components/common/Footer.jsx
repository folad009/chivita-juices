        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="space-y-3">
            ...
            <div className="text-sm text-white font-bold flex items-center space-x-2">
                ...
                <a href="tel:+234014662300" style={{ fontFamily: "Azo Sans, sans-serif", fontSize:"15px" }}>
                  +234 01 466 2300
                </a>
            </div>
            <div className="text-sm text-white font-bold flex items-center space-x-2">
                ...
                <a href="tel:+234017000890" style={{ fontFamily: "Azo Sans, sans-serif", fontSize:"15px" }}>
                  +234 01 700 0890
                </a>
            </div>
            <div className="text-sm text-white font-bold flex items-cente space-x-2">
                ...
                <a href="tel:+2349062875224" style={{ fontFamily: "Azo Sans, sans-serif", fontSize:"15px" }}>
                  +234 906 287 5224
                </a>
             ...
             <div className="text-sm text-white font-bold flex items-cente space-x-2">
                ...
                <a href="https://wa.link/7s14am" style={{ fontFamily: "Azo Sans, sans-serif", fontSize:"15px" }}>

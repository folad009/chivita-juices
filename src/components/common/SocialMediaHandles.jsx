...
const SocialMediaHandle = () => {
  return (
    <div className={styles.card}>
      {/*<a
        href="https://twitter.com/chivitajuices"
        target="_blank"
      ...
      >
        <svg
          className={`${styles.instagramSvg} ${styles.instagramSvg}`}
          viewBox="0 0 24 24"
        >
            {" "}
      ...
      >
        <svg
          className={`${styles.youtubeSvg} ${styles.youtubeSvg}`}
          viewBox="0 0 24 24"
        >
          {" "}
      ...
      >
        <svg
          className={`${styles.facebookSvg} ${styles.facebookSvg}`}
          viewBox="0 0 24 24"
        >
            {" "}

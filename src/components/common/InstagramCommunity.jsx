      ...
      {/*<header className={styles.header}>
        ...
        <div className="space-x-10">
          <a
            ...
            target="_blank"
          >
            <svg role="img" viewBox="0 0 24 24" width="32" height="32" fill="#E4405F" xmlns="http://www.w3.org/2000/svg">
          ...
          {[
            {
              ...
              src: "/assets/images/instagram/chivita-1.webp",
            },
            {
              alt: "A smiling girl holding a juice",
              src: "/assets/images/instagram/chivita-IG-2.webp",
            },
            {
              alt: "Two men posing with Chivita products",
              src: "/assets/images/instagram/chivita-IG-3.webp",
            },
            {
              alt: "Two puppies sitting on a couch",
              src: "/assets/images/instagram/chivita-IG-4.webp",
            },
          ].map(({ alt, src }, index) => (

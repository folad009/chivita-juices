...
const OverviewHero = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto px-2 sm:px-6 lg:px-8 pt-5 pb-5 mt-20 mb-20">
        {/* Title */}
        <div className="mt-5 max-w-4xl text-center mx-auto">
          <h1 className="block font-bold text-gray-800 text-5xl dark:text-neutral-200" style={{ fontFamily: "Bebas Neue, sans-serif" }}>
            Providing the Goodness of{' '}
